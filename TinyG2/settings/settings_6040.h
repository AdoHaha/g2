...
#define MOTOR_POWER_LEVEL_ABC       0.700
...
#define X_VELOCITY_MAX              2000.0                   // xvm  G0 max velocity in mm/min
#define X_FEEDRATE_MAX              X_VELOCITY_MAX          // xfr  G1 max feed rate in mm/min
#define X_TRAVEL_MIN                -420                       // xtn  minimum travel for soft limits
#define X_TRAVEL_MAX                420                     // xtm  travel between switches or crashes
#define X_JERK_MAX                  500.0                   // xjm ( in millions) 
...
#define Y_VELOCITY_MAX              2000.0
#define Y_FEEDRATE_MAX              Y_VELOCITY_MAX
#define Y_TRAVEL_MIN                -420
